...
# Define a system message that provides context to the AI chatbot about its roles and behavior.
...
def RealtimeInformation():
    ...
    month = current_date_time.strftime("%B")  # Month of the year.
    year = current_date_time.strftime("%Y")  # Year.
    hour = current_date_time.strftime("%I")  # Hour in 12-hour format.
...
# Function to modify the chatbot's system for better formatting.
...
def ChatBot(query):
    ...
    try:
        ...
        Answer = ""  # Initialize an empty string to store the generated AI response.
